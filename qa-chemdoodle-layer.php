...
class qa_html_theme_layer extends qa_html_theme_base
{
	...
	function head_custom()
	{
        ...
        // if the page is the "Ask a Question" or "Answer Questions" page, find the completed drawing, invoke the
        // upload script to save the drawing on the server, then submit the question form as usual
        if (($this->template === 'ask') or ($this->template === 'question')) {
            $this->output(
                '<SCRIPT>',
                'function mySubmit() {',
